                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
                    <div className="bg-white dark:bg-orange-900 px-6 py-12 shadow-sm sm:rounded-lg sm:px-12">
                        <form method="POST" className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div>
                                <label htmlFor="password" className="block text-sm/6 font-medium text-gray-900 dark:text-amber-300">
                                    Password
                                </label>
                                <div className="mt-2">
                                    <input
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex gap-3">
                                    ...
                                    <label htmlFor="remember-me" className="block text-sm/6 text-gray-900 dark:text-amber-300">
                                        Remember me
                                    </label>
                                </div>

                                <div className="text-sm/6">
                                    <a href="/auth/signin/" className="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-cyan-400">
                                        Login
                                    </a>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="relative mt-10">
                                <div aria-hidden="true" className="absolute inset-0 flex items-center">
                                    <div className="w-full border-t border-gray-200 dark:border-orange-700" />
                                </div>
                                <div className="relative flex justify-center text-sm/6 font-medium">
                                    <span className="bg-white px-6 text-gray-900 dark:text-amber-300 dark:bg-orange-700">Or continue with</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 grid grid-cols-2 gap-4">
                                <a
                                    href="#"
                                    className="flex w-full items-center justify-center gap-3 rounded-md bg-white dark:bg-amber-700 px-3 py-2 text-sm font-semibold text-gray-900 dark:text-amber-300 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus-visible:ring-transparent"
                                >
