    ...
    return (
        <div className='w-full'>
            ...
            <div className='my-4'>
                ...
                {isAdmin && (
                    <>
                        <Link className='ml-4 px-5 py-3 text-sm font-medium text-center text-white bg-green-700 rounded-lg cursor-pointer hover:bg-green-800 focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800' href="/filter-editor">Редактор фильтров</Link>
                        <Link className='ml-4 px-5 py-3 text-sm font-medium text-center text-white bg-green-700 rounded-lg cursor-pointer hover:bg-green-800 focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800' href="/api/logs">Logs</Link>
                        <Link className='ml-4 px-5 py-3 text-sm font-medium text-center text-white bg-purple-700 rounded-lg cursor-pointer hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800' href="/api/database/download">Скачать БД</Link>
                    </>
                )}
            </div>
